package com.boontaran.games.pengpeng.screens;
...
import com.boontaran.games.pengpeng.LevelButton;
...
public class LevelMap extends StageGame {
    ...
    private Table buildBackgroundLayer () {
        ...
        NinePatch patch = new NinePatch(SPengPeng.atlas.findRegion("map_bg"), 2, 2, 2, 2);
   ...
   /* public LevelButton getLevelButton(int level) {
        ...
        Labelstyle.font = SPengPeng.font1;
        ...
        if (stars >= 0) {
            for (int star = 0; star < 3; star++) {
                if (stars > star) {
                    starTable.add(new Image(SPengPeng.atlas.findRegion("star_y"))).width(20).height(20);
    ...
    public Button getLevelButton(int world, int level) {
        Button button = new Button(new Image(SPengPeng.atlas.findRegion("star_y")).getDrawable());
        ...
        if (stars >= 0) {
            for (int star = 0; star < 3; star++) {
                if (stars > star) {
                    starTable.add(new Image(SPengPeng.atlas.findRegion("star_y"))).width(35).height(35);
                } else {
                    starTable.add(new Image(SPengPeng.atlas.findRegion("star_g"))).width(35).height(35);
                }
            }
        }
...
/*    public LevelButton getLevelButton(int level){
        ...
        totalScore += SPengPeng.data.getScore(1);
