...
public class MysteryBox extends Entity {
	...
	public MysteryBox(Level level,Rectangle rect) {
		...
		img = new Image(SPengPeng.atlas.findRegion("mystery_box"));
		imgHit = new Image(SPengPeng.atlas.findRegion("mystery_box_hit"));
		imgInactive = new Image(SPengPeng.atlas.findRegion("mystery_box_inactive"));
