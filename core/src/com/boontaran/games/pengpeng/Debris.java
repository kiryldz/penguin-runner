...
public class Debris extends Entity implements Poolable {
	...
	public Debris() {
		d1 = new Image(SPengPeng.atlas.findRegion("brick_d1"));
		d2 = new Image(SPengPeng.atlas.findRegion("brick_d2"));
		d3 = new Image(SPengPeng.atlas.findRegion("brick_d3"));
		d4 = new Image(SPengPeng.atlas.findRegion("brick_d4"));
		setSize(3, 3);
