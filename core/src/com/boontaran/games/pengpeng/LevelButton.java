...
public class LevelButton extends Group {
	...
	public LevelButton(int id, String name) {
		...
		NinePatch patch = new NinePatch(SPengPeng.atlas.findRegion("level_select_bg"), 14, 14, 14, 14);
		style.up = new NinePatchDrawable(patch);
		
		NinePatch patch2 = new NinePatch(SPengPeng.atlas.findRegion("level_select_bg_down"), 14, 14, 14, 14);
		style.down = new NinePatchDrawable(patch2);
				
		NinePatch patch3 = new NinePatch(SPengPeng.atlas.findRegion("level_select_bg_disabled"), 14, 14, 14, 14);
