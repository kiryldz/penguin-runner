package com.boontaran.games.pengpeng.enemies;

import com.boontaran.games.Clip;
import com.boontaran.games.pengpeng.Pengpeng;
...
public class Enemy2 extends Enemy1 {
	...
	public Enemy2() {
		...
		//images of turtle
		clip = new Clip(SPengPeng.atlas.findRegion("enemy2") , 90,72);
		setClip(clip);
		clip.setFPS(12);
		...
		walkFrames = new int[]{0,1,2,3,2,1};
	...
	private void setSliding(Pengpeng hero) {
		sliding = true;
		speed = 400;
		if(getX() > hero.getX()) {
			isMoveRight = true;
