package com.boontaran.games.pengpeng.control;
...
public class JoyStick extends Group {
	...
	public JoyStick(float minHeight) {
		//idle image
		idle = new Image(SPengPeng.atlas.findRegion("joystick"));
		addActor(idle);
		...
		right = new Image(SPengPeng.atlas.findRegion("joystick_right"));
		right.setSize(getWidth(), getHeight());
		addActor(right);
		
		left = new Image(SPengPeng.atlas.findRegion("joystick_left"));
