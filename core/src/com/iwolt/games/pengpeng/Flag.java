...
public class Flag extends Entity {
	...
	public Flag() {
		...
		NinePatch patch = new NinePatch(SPengPeng.atlas.findRegion("pole"),7,7,4,4);
		...
		flag = new Image(SPengPeng.atlas.findRegion("flag"));
		group.addActor(flag);
		group.addActor(pole);
		...
		//accessories of pole
		Image top = new Image(SPengPeng.atlas.findRegion("pole_top"));
		group.addActor(top);
